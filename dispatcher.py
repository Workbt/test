...
class Dispatcher(DataMixin, ContextInstanceMixin):
    ...
    async def process_updates(self, updates, fast: typing.Optional[bool] = False):
        """
    ...
    async def start_polling(self,
        ...
        try:
            ...
            if current_request_timeout is not sentinel and timeout is not None:
                request_timeout = aiohttp.ClientTimeout(total=current_request_timeout.total + timeout or 5)
            else:
